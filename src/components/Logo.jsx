  ...
  return (
    <>
      <div className='grid grid-cols-[1fr 1fr] grid-rows-[auto auto] gap-x-5 max-sm:gap-x-2'>
        <img src="/public/assets/img/tweettery.png" alt="logo" className="w-20 h-20 max-sm:w-14 max-sm:h-14 max-[350px]:hidden rounded-full bg-gradient-to-r from-rose-400 via-rose-300 to-rose-200 dark:bg-gray-100 dark:from-sky-600 dark:via-sky-700 dark:to-sky-900 col-[1/2] row-[1/3] self-center" />
