  ...
  return (
    <>
      <div className='grid grid-cols-[1fr 1fr] grid-rows-[auto auto] gap-x-5'>
        ...
        <h1 className="leading-none text-8xl text-center font-arista text-sky-900 dark:text-sky-400 col-[2/3] row-[1/2]">Tweettery</h1>
        <p className="text-lg text-gray-600 dark:text-white col-[2/3] row-[2/3] ml-4">{`Summary (almost) any twitter profile `}</p>
      </div>
    </>
  )
}
